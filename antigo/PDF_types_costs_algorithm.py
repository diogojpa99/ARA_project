...
data_types_costs = np.loadtxt('types_costs_algorithm.txt')
...
plot1.set_title('Histograma dos tipos das rotas resultantes do algoritmo')
...
plot2.set_title('PDF dos tipos de rotas resultantes do algoritmo')
...
plot3.set_title('Histograma dos custos das rotas resultantes do algoritmo')
...
plot4.set_title('PDF dos custos das rotas resultantes do algoritmo')
